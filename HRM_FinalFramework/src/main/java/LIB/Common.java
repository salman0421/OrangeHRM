...
public class Common 
{
	...
	public void verifyElementInTableAndClick(String xpathlocator,String text)
	{
		
		WebElement e=FindElementByLoc("xpath",xpathlocator);
		if(e.getText().equals(text))
		{
			e.click();
		}
	...
	public void verifyElementInTableandClick(String xpathlocator)
	{
		WebElement e=FindElementByLoc("xpath", xpathlocator);
		e.click();
	}
	...
	//Wait until the Element is present
		public void waitUntilElementPresent(String elementpath)
		{
			...
			WebElement elementpresent= (new WebDriverWait(driver,60)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(elementpath)));
		}
		public WebElement getAttribute(String identifier,String locator)
		{
			WebElement e=FindElementByLoc(identifier,locator);
			e.getAttribute(locator);
			return e;
		}
		public void verifyElementInTableandClick(String xpathlocator,String text)
		{
